...
import { useDragShadow } from "../hooks/use-drag-shadow";
import { type FormattedFile, cn, formatBytes, formatFile } from "../lib/utils";
import {
  type DragControls,
  Reorder,
  useDragControls,
...
const FileCardContent = ({
  ...
  return (
    <div
      className={cn(
        "relative flex select-none items-start space-x-4 rounded-lg border border-border bg-background p-3",
        className,
      )}
    >
